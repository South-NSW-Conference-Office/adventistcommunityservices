...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Footer */}
      <footer className="bg-[#1a2332] mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="/about" className="text-gray-400 hover:text-[#F44314] transition-colors">About Us</a></li>
                <li><a href="/services" className="text-gray-400 hover:text-[#F44314] transition-colors">Services</a></li>
                <li><a href="/fellowship" className="text-gray-400 hover:text-[#F44314] transition-colors">Fellowship</a></li>
                <li><a href="/teams" className="text-gray-400 hover:text-[#F44314] transition-colors">Teams</a></li>
                <li><a href="/contact" className="text-gray-400 hover:text-[#F44314] transition-colors">Contact</a></li>
              </ul>
            </div>
            <div>
